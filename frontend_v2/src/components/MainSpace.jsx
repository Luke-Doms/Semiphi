...
function MainSpace() {
  ...
  return (
    <div className='mainspace'>
        ...
        {modal ? <Modal closeModal={() => {setModal(false); setContactUs(false)}} /> : null}
        ...
        <div className='bottombar'>
            <div onClick={() => {setModal(true); setContactUs(true)}}>
            ...
            <div onClick={() => (window.open('https://github.com/Luke-Doms/Semiphi'))}>
              <span>Github</span>
